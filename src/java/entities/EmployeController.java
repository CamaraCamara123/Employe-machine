...
public class EmployeController implements Serializable {
    ...
    @EJB
    private entities.EmployeFacade ejbFacade;
    ...
    public List<Employe> getItems() {
        if (items == null) {
            if(selectedEmployeeId != null){
                items = Collections.singletonList(getFacade().find(selectedEmployeeId));
            }else{
    ...
    public void setSelectedEmployeeId(Integer selectedEmployeeId) {
        ...
        // Reset the items to trigger re-query with the new filter
        items = null;
    }
